      ...
      notification: function () {
        ...
        $("#notification_tbl").dataTable({
          ...
          createdRow: function (row, data, dataIndex) {
            ...
            $(row).find("td.docs_status").html(docs_status).attr({
            ...
            let html_action = () => {
              ...
              if (_utype == "user_np" && data.docs_status == 1)
                return `
      ...
      cancelled: function () {
        ...
        $("#cancelled_tbl").dataTable({
          ...
          createdRow: function (row, data, dataIndex) {
            ...
            $(row).find("td.status").html(stat).attr({
              "data-tbl_id": data.tbl_id,
            })
      ...
      approval: function () {
        ...
        $("#approval_tbl").dataTable({
          ...
          createdRow: function (row, data, dataIndex) {
            ...
            $(row).find("td.docs_status").html(stat).attr({
              "data-tbl_id": data.tbl_id,
            })
...
$(document)
  .off("click", ".btn-read_message")
  .on("click", ".btn-read_message", function () {
  ...
  .off("click", ".view_docs_details")
  .on("click", ".view_docs_details", function () {
  ...
  .off("click", ".process_document")
  .on("click", ".process_document", function () {
                ...
                app.email_notification(
                  {
                    ...
                    file_name: "email_notification_process",
                  },
                  function (resp) {
                ...
                app.email_notification(
                  {
                    ...
                    form_name: form,
                    process_remarks: process_remarks == "" ? "N/A" : process_remarks,
                    file_name: "email_notification_reject",
                  },
                  function (resp) {
                    console.log("pre pros", { resp })
                    return resolve(resp)
  ...
  .off("click", ".search_data")
  .on("click", ".search_data", function () {
